...
import Info from './InfoContacts/Info.jsx';
...
function App() {
  ...
  return (
    <>
      ...
      <div className='h-full w-16 bg-white'>
      <div
      className="flex flex-col justify-center items-center relative transition-all duration-[450ms] ease-in-out w-16 h-screen"
    ...
    >
      ...
      >
        ...
        <div className='bg-black h-full w-2/3'>
        <Routes>
            <Route path='/contact/:id' element={<Info/>}></Route>
          </Routes>        
          </div>
      </div>
      </Router>
